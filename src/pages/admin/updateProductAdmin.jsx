...
export default function UpdateProductPage(){
    ...
    return( 
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-[600px] border-[3px] rounded-[15px] flex flex-wrap justify-between p-[35px]">
                <div className="w-[200px] flex flex-col gap-[5px]">
                    <label className="text-sm font-semibold">Product ID:</label>
                    <input type="text" disabled value={productId} onChange={(e)=>{setProductId(e.target.value)}} 
                ...
                <div className="w-[500px] flex flex-col gap-[5px]">
                    ...
                    <input type="text" value={alternativeNames} onChange={(e)=>{setAlternativeNames(e.target.value)}} 
                    className="w-full border-[1px] h-[40px] rounded-md shadow-2xl" />
                </div>
                <div className="w-[200px] flex flex-col gap-[5px]">
                ...
                <div className="w-[500px] flex flex-col gap-[5px]">
                    ...
                    className="w-full border-[1px] h-[100px] rounded-md shadow-2xl" />
                </div>
                <div className="w-[200px] flex flex-col gap-[5px]">
                ...
                <div className="w-[450px] flex flex-col gap-[5px]">
                ...
                <div className="w-full flex justify-center flex-row py-[20px]">
                    <Link to="/admin/products" className="w-[200px] h-[50px] border-[2px] bg-white text-black font-semibold rounded-md shadow-2xl flex items-center justify-center cursor-pointer">Cancel</Link>
                    <button onClick={handleSubmit} className="w-[200px] h-[50px] bg-black text-white rounded-md shadow-2xl flex items-center justify-center cursor-pointer ml-[20px]">Update Product</button>
                </div>
            </div>
        </div>
    );
