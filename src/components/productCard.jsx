...
export default function productCard(props) {
    ...
    return(
        <Link to={"/overview/" + product.productId} className="w-[300px] h-[400px] shrink-0 shadow-2xl rounded-xl overflow-hidden flex flex-col">
            <img src={product.images[0]} className="w-full h-[275px] object-cover"/>
            <div className=" w-full h-[125px] flex flex-col p-[3px]">
                <span className="text-gray-500 text-[14px]">{product.productId}</span>
                <h1 className="text-l font-bold">{product.name} {" "}
